    ...
    return (
        <div className='button-controls'>
            ...
            <div className="links links-web"> 
                <a className='liberTea' href="https://www.paypal.com/donate/?hosted_button_id=AVT886QL88AD6" target="_blank"><img src={liberTea} alt="Tea Icon"/>Give me some <strong>LIBER-TEA</strong></a>
